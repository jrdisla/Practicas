...
<div class="col-sm-9">
    ...
    <form action="/individualInfo/${articulo.id?string["0"]}/" method="post" id="ac">
        <div class="input-group" margin="auto">
            Titulo: <input name="titulo" type="text" class="form-control" value="${articulo.title}" placeholder="Username" aria-describedby="basic-addon1">
        </div>

        <div class="input-group" margin="auto">
            Tags: <input name="tags" type="text" class="form-control" value="${tags}" placeholder="Separated by comma" aria-describedby="basic-addon1">
        </div>

        <div class="form-group">
            <label for="comment">Cuerpo:</label>
            <textarea name="comment" class="form-control" rows="5" id="ac">${articulo.body}</textarea>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <p class="copyright text-muted">Copyright &copy; Spark Blog 2017</p>
            </div>
        </div>
    </div>
</footer>
